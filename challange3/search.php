...
$sqlget="SELECT * FROM universitie WHERE country='$country'";
...
if($count>0){
    ...
    exit();
      ...
      $init=curl_init("http://universities.hipolabs.com/search?country=$country");
...
file_put_contents('country.json',$ex);
...
$stmt=$mysqli->prepare("INSERT INTO universitie(country,name) VALUES(?,?)");
